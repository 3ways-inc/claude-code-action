...
## Fork Changes (3ways-inc/claude-code-action@beta)
...
- **Updated Base Action**: Uses `3ways-inc/claude-code-base-action@beta` which includes OAuth credential handling
